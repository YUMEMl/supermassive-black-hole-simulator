...
The Vulkan build has been verified on Arch Linux with an NVIDIA GeForce RTX 2080 Ti at the 20 FPS cap. The existing Windows/OpenGL build was previously verified on an NVIDIA GeForce RTX 4070 Ti. Actual performance depends mainly on GPU fragment-shader throughput and display resolution.
